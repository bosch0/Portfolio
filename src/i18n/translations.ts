  ...
  en: {
    ...
    projectsData: {
      ...
      portfolio: {
        ...
        description:
          'Minimalist and modern web portfolio showcasing my projects and skills as a developer. Built with React, TypeScript, and Vite for maximum performance. Responsive design using Tailwind CSS, featuring smooth animations and dark mode support. Modular architecture with clean code that reflects frontend development best practices.',
        github: 'GitHub',
        demo: 'Demo',
      },
    },
  ...
  es: {
    ...
    projectsData: {
      ...
      portfolio: {
        ...
        description:
          'Portafolio web minimalista y moderno que muestra mis proyectos y habilidades como desarrollador. Construido con React, TypeScript y Vite para un rendimiento máximo. Diseño responsive con Tailwind CSS, con animaciones suaves y soporte para modo oscuro. Arquitectura modular con código limpio que refleja buenas prácticas de frontend.',
        github: 'GitHub',
        demo: 'Demo',
      },
    },
